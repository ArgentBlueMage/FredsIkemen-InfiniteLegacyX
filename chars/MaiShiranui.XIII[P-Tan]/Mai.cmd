...
value = 3500
triggerall = var(59) <= 0
triggerall = command = "NEO MAX" || fvar(6) = 3500
triggerall = power >= 3000 || (var(29) >= 1 && var(20) > 0 && power >= 2000)
triggerall = var(20) > 0 || var(19) >= 1000
trigger1 = ctrl
...
triggerall = var(59) <= 0
triggerall = power >= 2000
triggerall = command = "超忍蜂EX" || fvar(6) = 3050
triggerall = statetype = A
triggerall = var(20) > 0 || var(19) >= 500
...
triggerall = var(59) <= 0
triggerall = power >= 1000
triggerall = command = "超忍蜂" || fvar(6) = 3000
triggerall = statetype = A
triggerall = var(20) > 0 || var(19) >= 500
trigger1 = stateno = 1200 && movecontact = [1,5]
trigger2 = stateno = 1300 && movecontact = [1,5]
...
value = 1400
triggerall = var(59) <= 0
triggerall = command = "ムササビ" || fvar(6) = 1400
triggerall = statetype != A
...
triggerall = var(59) <= 0
triggerall = power >= 1000
triggerall = command = "龍炎舞EX" || fvar(6) = 2100
triggerall = var(20) > 0 || var(19) >= 500
triggerall = statetype = A
trigger1 = stateno = 1200
trigger1 = (movehit = [1,5]) || (var(20) > 0 && movecontact = [1,5])
trigger2 = stateno = 2200
trigger2 = (movehit = [1,5]) || (var(20) > 0 && movecontact = [1,5])

trigger3 = stateno = 1300
trigger3 = (movehit = [1,5]) || (var(20) > 0 && movecontact = [1,5])
...
value = 1300
triggerall = var(59) <= 0
triggerall = command = "龍炎舞" || fvar(6) = 1100
triggerall = statetype = A
triggerall = var(20) > 0 || var(19) >= 500
trigger1 = stateno = 1200
trigger1 = (movehit = [1,5]) || (var(20) > 0 && movecontact = [1,5])
...
triggerall = var(59) <= 0
triggerall = power >= 1000
triggerall = command = "忍蜂EX" || fvar(6) = 2200
triggerall = statetype != A
triggerall = var(20) > 0 || var(19) >= 500
trigger1 = stateno = 1100
trigger1 = (movehit = [1,5]) || (var(20) > 0 && movecontact = [1,5])
...
value = 1200
triggerall = var(59) <= 0
triggerall = command = "忍蜂" || fvar(6) = 1200
triggerall = statetype != A
triggerall = var(20) > 0 || var(19) >= 500
trigger1 = stateno = 1100
trigger1 = (movehit = [1,5]) || (var(20) > 0 && movecontact = [1,5])
...
trigger4 = (movehit = [1,5]) || (var(20) > 0 && movecontact = [1,5])
...
value = 850
triggerall = var(59) <= 0
triggerall = command = "y" || fvar(6) = 850
triggerall = command = "holdfwd" || command = "holdback"
triggerall = statetype = A
triggerall = ctrl
trigger1 = p2bodydist X < 5
